...
class TestDescriptionManager:
    ...
    def test_apply_empty_description_html(
        self, test_description_html_manager: DescriptionManager, description_handler_mock: mock.MagicMock
    ) -> None:
        test_description_html_manager.apply_description()
        description_handler_mock.assert_not_called()

    def test_apply_description_html(
        self, test_description_html_manager: DescriptionManager, faker: Faker, description_handler_mock: mock.MagicMock
    ) -> None:
        test_description_html_manager.add_description(faker.word())
        test_description_html_manager.apply_description()
