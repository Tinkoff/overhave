...
class TestDescriptionManager:
    ...
    def test_add_description_html(self, test_description_html_manager: DescriptionManager, faker: Faker) -> None:
    ...
    def test_add_description_above_html(self, test_description_html_manager: DescriptionManager, faker: Faker) -> None:
        test_description_html_manager.add_description(faker.word())
    ...
    def test_apply_empty_description_html(
        self, test_description_html_manager: DescriptionManager, description_html_handler_mock: mock.MagicMock
    ) -> None:
    ...
    def test_apply_empty_description(
        self, test_description_manager: DescriptionManager, description_html_handler_mock: mock.MagicMock
    ) -> None:
    ...
    def test_apply_description_html(
        self,
        test_description_html_manager: DescriptionManager,
        faker: Faker,
