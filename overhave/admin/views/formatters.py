...
def datetime_formatter(view: ModelView, context: Any, model: Any, name: str) -> Markup:  # pylint: disable=W0613
...
def task_formatter(view: ModelView, context: Any, model: Any, name: str) -> Markup:  # pylint: disable=W0613
...
def json_formatter(view: ModelView, context: Any, model: Any, name: str) -> Markup:  # pylint: disable=W0613
